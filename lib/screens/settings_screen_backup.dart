...
class _SettingsScreenState extends State<SettingsScreen> {
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              // Validate input - allow only alphanumeric and dashes
              inputFormatters: [
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              // Validate key format - Picovoice keys are typically 20+ chars
              if (key.length < 20) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Invalid access key format. Key should be at least 20 characters.'),
                    backgroundColor: Colors.red,
                  ),
                );
                return;
              ...
              if (key.isNotEmpty) {
                ...
                await WakeWordManager.instance.startListening(key);
                setState(() {
                  _picovoiceAccessKey = key;
                });
                if (mounted) {
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSettingsTile(
            ...
            onTap: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Profile customization coming soon!')),
              );
            },
          ),
          ...
          _buildSettingsTile(
            ...
            onTap: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Use the Test Microphone button above to test wake word!')),
              );
            },
          ),
          const SizedBox(height: 32),
  ...
  @override
  void dispose() {
    // Dispose controllers and services to prevent memory leaks
